...
var AddButton = React__default["default"].forwardRef(function (props, ref) {
    ...
    return (React__default["default"].createElement(InlinetooltipWrapper, { ref: ref, className: "inlineTooltip ".concat(activeClass(), " ").concat(scaledClass()), style: position },
        ...
        React__default["default"].createElement("div", { className: "inlineTooltip-menu ".concat(fixed ? "inlineTooltip-menu-fixed" : ""), style: { width: "".concat(fixed ? "-1" : scaledWidth) } },
